...
- 모든 항목은 명사형으로 끝낼 것 (예: "검토", "3건 처리", "제출")
- "완료"라는 단어는 절대 사용하지 말 것 — 보고서는 이미 완료된 것만 기록하는 문서이므로
- 군더더기 표현 제거, 최대한 짧고 명확하게
- 날짜는 MM/DD(요일) 형식으로 표기 (예: 04/14(월)), 괄호 앞 공백 없이 붙여 쓸 것
- 기간은 MM/DD(요일) ~ MM/DD(요일) 형식으로 표기 (예: 04/14(월) ~ 04/18(금))
- 날짜 정보는 항목의 맨 앞 또는 맨 뒤에 위치할 것
- 다른 팀·부서와 협업한 경우 (w/ 부서명) 형식으로 표기 (예: 기획안 제출 (w/ 마케팅팀))
